...
type ServiceListItemOutput struct {
	ID          int64  `json:"id" form:"id" example:"1"`                    //id
	...
	LoadType    int    `json:"load_type" form:"load_type" example:"1"`      //类型
	ServiceAddr string `json:"service_addr" form:"service_addr" example:""` //服务地址
	Qps         int64  `json:"qps" form:"qps" example:"1"`                  //qps
	Qpd         int64  `json:"qpd" form:"qpd" example:"1"`                  //qpd
	TotalNode   int    `json:"total_node" form:"total_node" example:"1"`    //节点数
}
